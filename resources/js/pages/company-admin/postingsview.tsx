...
export default function PostingsView({ company, posting, success, error }: Props) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Job posting details and information for {company.name}
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {posting.supervisor_name && (
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-full bg-indigo-100 dark:bg-indigo-900/20">
                      <Users className="h-4 w-4 text-indigo-600 dark:text-indigo-400" />
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Supervisor</p>
                      <p className="text-sm text-gray-900 dark:text-white">{posting.supervisor_name}</p>
                    </div>
                  </div>
                )}
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <Button variant="outline" className="w-full justify-start" asChild>
                  <Link href={`/company-admin/postings/${posting.posting_id}/edit`}>
                    Edit Posting
                  </Link>
                </Button>
                <Button variant="outline" className="w-full justify-start" asChild>
