...
export default function DepartmentEdit({ department, deptHeads, error: initialError, success: initialSuccess }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        dept_head_id: department.dept_head_id?.toString() || null,
    });

    const handleSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/departments/${department.department_id}`, {
            onSuccess: () => {
                setShowSuccess(true);
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="rounded-2xl p-6 bg-gradient-to-r from-indigo-500 to-blue-600 dark:from-indigo-700 dark:to-blue-800 text-white shadow-lg">
                    <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Edit Department</h1>
                    <p className="text-white/90 mt-1">Update details and department head</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
                    ...
                    <div className="flex gap-4">
                        <Button type="submit" disabled={processing} aria-label="Update department" className="rounded-full bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700">
