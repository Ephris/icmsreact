...
interface FacultyAdvisorFormsTrashedProps {
  trashedForms: {
    data: Form[];
...
export default function FacultyAdvisorFormsTrashed({
  trashedForms,
  filters,
  success,
  error,
}: FacultyAdvisorFormsTrashedProps) {
  ...
  const handleSearch = (value: string) => {
    setSearch(value);
    router.get('/faculty-advisor/forms/trashed', {
      search: value,
      type,
      sort_by: sortBy,
      sort_dir: sortDir,
  ...
  const handleFilter = (filterType: string, value: string) => {
    ...
    router.get('/faculty-advisor/forms/trashed', newFilters, {
      preserveState: true,
      replace: true,
    });
  };
          ...
          <CardContent>
            ...
            {trashedForms.data.length > 0 && (
              <div className="flex items-center justify-between mt-4">
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  Showing {trashedForms.meta?.from || 0} to {trashedForms.meta?.to || 0} of {trashedForms.meta?.total || 0} trashed forms
                </div>
                <div className="flex gap-2">
                  {trashedForms.links.map((link: PaginationLink, index: number) => (
                    <Button
                      key={index}
...
// import { Badge } from '@/components/ui/badge';
// import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
// import { Search, ArrowUpDown, FileText, ArrowLeft, RotateCcw, Download } from 'lucide-react';
// import { useState } from 'react';
...
//         <Card>
//           <CardHeader>
//             <CardTitle>Deleted Forms</CardTitle>
//             <CardDescription>
//               Forms that have been deleted and can be restored
//             </CardDescription>
//           </CardHeader>
//           <CardContent>
//             <div className="flex flex-col sm:flex-row gap-4 mb-6">
...
//                 </div>
//                 <div className="flex gap-2">
//                   {trashedForms.links.map((link, index) => (
//                     <Button
//                       key={index}
//                       variant={link.active ? "default" : "outline"}
//                       size="sm"
