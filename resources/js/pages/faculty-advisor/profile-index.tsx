...
const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Dashboard', href: '/faculty-advisor' },
  { title: 'Profile', href: '/faculty-advisor/profile' },
];
      ...
      <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <Button asChild className="bg-indigo-600 text-white hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600">
                  <Link href="/faculty-advisor/profile/edit">Edit Profile</Link>
                </Button>
              </div>
            </div>
          </CardContent>
                ...
                <>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{department.head_name}</p>
                    </div>
                  </div>
                </>
              ) : (
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Button asChild variant="outline" className="border-gray-300 dark:border-gray-600">
            <Link href="/faculty-advisor">Back to Dashboard</Link>
          </Button>
        </div>
      </div>
    </AppLayout>
