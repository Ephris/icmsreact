...
interface FacultyAdvisorFormsCreateProps {
...
export default function FacultyAdvisorFormsCreate({
  assignedStudents,
  supervisors,
  success,
  error,
}: FacultyAdvisorFormsCreateProps) {
  ...
  useEffect(() => {
    if (formData.student_id) {
      const selectedStudent = assignedStudents.find(student => student.student_id === formData.student_id);
      if (selectedStudent) {
        setFormData(prev => ({ ...prev, supervisor_id: selectedStudent.supervisor_id }));
      }
    }
  }, [formData.student_id, assignedStudents]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.post('/faculty-advisor/forms', formDataToSend, {
            ...
            <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.supervisor_id} disabled>
                    <SelectTrigger>
                      <SelectValue placeholder="Supervisor will be auto-selected" />
                    </SelectTrigger>
                    <SelectContent>
