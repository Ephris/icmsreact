...
export default function Profile({ user, company, success, error }: Props) {
  ...
  const handleSubmit = () => {
    ...
    router.post('/department-head/profile', data, {
      onSuccess: () => {
        setShowSuccess(true);
      ...
      <div className="p-6 space-y-6">
          ...
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              <div className="relative">
                ...
                <label className="absolute -bottom-2 -right-2 bg-white dark:bg-gray-800 rounded-full p-2 shadow-lg cursor-pointer">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Button asChild variant="outline" className="border-gray-300 dark:border-gray-600">
            <Link href="/department-head/profile">Cancel</Link>
          </Button>
        </div>
      </div>
    </AppLayout>
