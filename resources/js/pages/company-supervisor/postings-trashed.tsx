...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Trashed Postings', href: '/company-supervisor/postings-trashed' },
];
...
export default function PostingsTrashed({ company, trashedPostings, filters, success, error }: Props) {
  ...
  const handleRestore = (posting_id: number) => {
    ...
    router.post(`/company-supervisor/postings/${posting_id}/restore`, {}, {
      onSuccess: () => {
        ...
        <Card className="shadow-lg border-none bg-white dark:bg-gray-800 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl">
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              >
                <Link href="/company-supervisor/postings" aria-label="Back to postings">
                  Back to Postings
                </Link>
              </Button>
            </div>
                  ...
                  <PaginationContent>
                    ...
                    {[...Array(trashedPostings.last_page)].map((_, i) => (
                      <PaginationItem key={i}>
                        <PaginationLink
                          href={`/company-supervisor/postings-trashed?page=${i + 1}&search=${encodeURIComponent(searchTerm)}&type=${typeFilter}&sort_by=${
                            filters.sort_by
